...
const Header = () => (
  <header className="d-flex justify-content-between align-items-center p-2 my-2 me-2 ms-2 bg-white  rounded-3 "  style={{ width:'1112px'}}>
    <div className="d-flex">
      ...
      <div className="d-flex" style={{paddingLeft:"140px"}}>
